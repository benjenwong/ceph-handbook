...
* [第一部分：常用操作](Operation/common_operations.md)
    ...
    * [5. 增加/删除 OSD](Operation/add_rm_osd.md)
    * [6. 操作 Pool](Operation/operate_pool.md)
    * [7. 对象存储介绍](Operation/object_storage_introduce.md)
    * [8. 对象存储常用操作](Operation/rgw_operation.md)
